...
<body>
    <section>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top navbar-custom container">
            <a class="navbar-brand" href="index.php"><img src="{{ asset('dossiers/image/Impact-Web-360-Logo1.png') }}" alt="Logo Impact Web">
        ...
        <header class="hero-section text-center" data-aos="zoom-in">
            ...
            <div class="hero-slider">
                ...
                <div class="hero-slide"
                    style="background-image: url('https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80');">
                </div>
                <div class="hero-slide" style="background-image: url('images/homme2.png');"></div>
                <div class="hero-slide"
                    style="background-image: url('https://images.unsplash.com/photo-1497366811353-6870744d04b2?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80');">
                </div>
            </div>
            ...
            <div class="overlay">
                ...
                <a href="{{ route('step1') }}" class="btn btn-danger btn-lg mt-3 mb-5"><i
                        class="fa fa-ticket-alt me-2 "></i>Réserver mon billet →</a>
        ...
        <marquee behavior="" direction="">
            <div class="container d-flex flex-wrap justify-content-center gap-4">
                @foreach ($sponsors as $sponsor)
                    <div class="me-4 part"><img src="{{ asset('storage/' . $sponsor->logo) }}" alt="" width="50">
                        &nbsp;&nbsp;&nbsp;&nbsp;♦&nbsp;&nbsp;&nbsp;&nbsp;</div>
                @endforeach
            </div>
        </marquee>
    ...
    <section class="py-5 bg-black text-center taille" data-aos="fade-up">
        <div class="container">
            <p class="mb-5" style="color: #ccc;"><strong style="color: white; font-size: 20px;">Impact Web 360</strong>
                est bien plus qu'un simple événement, c'est un mouvement qui transforme la jeunesse africaine.
                Depuis notre création, nous avons formé et inspiré des centaines de jeunes entrepreneurs à travers des
                ateliers pratiques, des conférences stimulantes et un réseau solidaire.
                Notre communauté grandissante témoigne de l'impact réel de nos actions sur le développement des
    ...
    <section class="py-5 text-white text-center" data-aos="zoom-in">
        <div class="container">
            ...
            <div>
                ...
                <p class="mb-4 taille" style="color: #ccc;">Oser sans permissions, c'est maintenant tout commmence !
                </p>
            </div>
            <h2 class="mb-3"> </h2>
            <p class="lead"> </p>
            <div class="row mt-2 align-items-center mb-5" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="col-md-6">
                    <img src="{{ asset('dossiers/image/logo-tounée.jpg') }}" alt="Image événement"
    ...
    <section class="partners-section" data-aos="fade-up">
        <div class="container">
            ...
            <p data-aos="fade-up" data-aos-delay="100">
                ...
                Grâce à leur engagement, Impact Web 360 peut offrir une expérience unique, inspirante et accessible à
                tous.
            </p>
            ...
            <div class="d-flex flex-wrap justify-content-center gap-3 mt-3" data-aos="fade-up" data-aos-delay="200">
                <div class="logo-box" data-aos="zoom-in" data-aos-delay="300">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/8/87/Microsoft_Excel_2013-2019_logo.svg"
                        alt="Excel">
                </div>
    ...
    <section class="forum-section">
        <div class="container">
            <div class="row align-items-center">
                <!-- Texte -->
                <div class="col-md-6 order-1 order-md-1 text-center-mobile" data-aos="flip-down"
                    data-aos-duration="1000">
                    <h2 class="forum-title">Forum Impact Web 360</h2>
                    <p class="forum-text mt-3">
                        Rejoignez notre espace d'échange privilégié où entrepreneurs débutants et experts se connectent.
                        Partagez vos défis, obtenez des solutions personnalisées et collaborez sur des projets concrets
                        avec d'autres membres ambitieux de notre écosystème.
                    </p>
                ...
                <div class="col-md-6 order-2 order-md-2">
                    <div class="circle-container position-relative">
                        ...
                        <!-- Logo central fixe -->
                        <img src="{{ asset('dossiers/image/Impact-Web-360-Logo1.png') }}" alt="Impact Web"
                            class="center-logo">
                    </div>
                </div>
            </div>
    ...
    <section class="py-5 bg-black text-white">
        <div class="container" data-aos="zoom-in">
            ...
            <p class="mb-4 text-center">Affiche ton appartenance à la communauté des acteurs du digital avec nos
                produits exclusifs ! 👕 T-shirts Officiels, </p>
