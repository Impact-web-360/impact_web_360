...
<nav id="sidebar" aria-label="Sidebar Navigation">
  ...
  <a href="{{ route('formations.create')}}" class="nav-link "><i class="fa fa-store"></i>Formations</a>
  ...
  <a href="{{ route('categories.index') }}" class="nav-link active"><i class="fa fa-store"></i>Categorie</a>
