...
<body>
  ...
  <div class="container py-5 form-container">
    <div class="card p-4" data-aos="fade-up">
      <h2 class="mb-4 text-center">Ajouter un nouveau Replay</h2>
      ...
      <form action="{{ route('replay.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
          ...
          <input type="text" name="presentateur_nom" class="form-control" required>
        </div>

        <div class="mb-3">
          <label class="form-label fw-bold" style="font-size: 20px">Poste du présentateur</label>
          <input type="text" name="presentateur_poste" class="form-control" required>
        </div>
        ...
        <div class="d-flex justify-content-between mt-4">
          ...
          <a href="{{ route('replay.index') }}" class="btn btn-secondary px-4">
