          ...
          <div class="card-body">
            <form method="POST" action="{{ route('emploies.update', $emploie->id) }}" enctype="multipart/form-data">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nom" name="nom" value="{{ old('nom', $emploie->nom) }}" required>
              </div>

              <div class="mb-3">
                <label for="promoteur" class="form-label">Promoteur</label>
                <input type="text" class="form-control" id="promoteur" name="promoteur" value="{{ old('promoteur', $emploie->promoteur) }}" required>
              </div>

              <div class="mb-3">
                <label for="localisation" class="form-label">Localisation</label>
                <input type="text" class="form-control" id="localisation" name="localisation" value="{{ old('localisation', $emploie->localisation) }}">
              </div>

              <div class="mb-3">
                <label for="lien" class="form-label">Lien vers l'offre</label>
                <input type="url" class="form-control" id="lien" name="lien" value="{{ old('lien', $emploie->lien) }}" required>
              </div>
