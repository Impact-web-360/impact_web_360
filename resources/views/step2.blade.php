...
<head>
  ...
  <style>
    ...
    .form-section { background-color: white; border-radius: 1rem; padding: 2rem; color: black; margin-top: 2rem; }
    ...
    .seat-map { background: white; color: black; border-radius: 20px; padding: 2rem; margin-top: 1rem; text-align: center; }
    .seat-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(40px, 1fr)); gap: 10px; justify-items: center; }
    .seat { width: 45px; height: 45px; background: #f0f0f0; border-radius: 8px; display: flex; align-items: center; justify-content: center; font-weight: 500; cursor: pointer; }
    .seat.reserved { background: #999; cursor: not-allowed; }
    .seat.selected { background: #007bff; color: white; }
    .btn-suivant { margin-top: 30px; margin-bottom: 100px; background: #ff3d00; color: white; border-radius: 30px; padding: 10px 50px; font-weight: bold; font-size: 16px; }
...
<div class="step-nav mt-5 text-dark text-center">
    <div class="step-container">
      <span><strong class="text-primary"><a href="#"> Informations</a></strong></span>
...
<p>        🟦 🟦 🟦 🟩 🟩     </p>
<p> -----------------------------------------   </p>
                  <center><h4>Légende</h4></center>
<center><div class="d-flex mt-3 justify-content-center">
    <div class="me-3">
