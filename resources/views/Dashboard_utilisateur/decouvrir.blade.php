...
<head>
    ...
    <style>
        /* Variables CSS pour faciliter la gestion des couleurs et espacements */
            ...
            /* Hero Section Styles */
            .hero-section {
                background-color: #2a2cde; /* Dark blue from the mockup */
                display: flex;
                align-items: center;
                justify-content: center;
                border-radius: 30px; /* Rounded corners at the bottom */
            }

            .hero-content {
                z-index: 10; /* Ensure content is above illustrations */
                text-align: center;
                color: #fff;
            ...
            .categories-section {
                ...
                padding: 20px 0;
                border-radius: 0 0 20px 20px; /* Match hero section if desired */
            }
            ...
            .category-btn.active {
                background-color: #6a00ff; /* Purple for active button */
                color: #fff;
                box-shadow: 0 0 15px rgba(106, 0, 255, 0.5); /* Subtle glow */
            }
                    ...
                    <section class="container-fluid categories-section py-4">
                        <div class="container">
                            <div class="d-flex flex-wrap justify-content-center justify-content-lg-start gap-3">
                                ...
                                @foreach($categories as $categorie) {{-- *** IMPORTANT : $categorie au singulier *** --}}
