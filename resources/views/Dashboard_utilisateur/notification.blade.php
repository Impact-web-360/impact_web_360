...
<head>
    ...
    <title>Impact Web - Paramètres - Notification</title>
    ...
    <style>
        ...
        .notification-settings-form { /* Apply common padding to all settings forms */
        ...
        .password-card,
        .profile-card,
        .notification-card { /* Common styling for card-like sections */
            background-color: var(--dark-card-bg);
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid py-4 main-content">
                <div class="row">
                    ...
                    <div class="col-md-8 col-lg-9 notification-settings-form animation-fade-in" style="animation-delay: 0.2s;">
                        <h4 class="form-section-title mb-4">Notification</h4>

                        <div class="card notification-card mb-4">
                            <div class="card-body">
                                <h5 class="card-title">Notification Push</h5>
                                <p class="card-subtitle mb-3 text-muted">Recevez des notifications push pour rester à jour sur les activités même lorsque vous êtes loin des cours. Vous avez la possibilité de les désactiver à tout moment. Cette préférence s'applique à tout compte accessible via ce navigateur.</p>
                                <div class="d-flex justify-content-end align-items-center mb-3">
                                    <div class="form-check form-switch custom-switch">
                                        <input class="form-check-input" type="checkbox" id="pushNotifications" checked>
                                        <label class="form-check-label d-none" for="pushNotifications">Toggle push notifications</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card notification-card mb-4">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    ...
                                    <div class="form-check custom-checkbox">
                                        <input class="form-check-input" type="checkbox" id="emailReminderSchedules" checked>
                                        <label class="form-check-label d-none" for="emailReminderSchedules">Toggle Horaires de rappel</label>
                                    </div>
                                </div>

                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <span class="text-white-50">Cours de paiement</span>
                                    <div class="form-check custom-checkbox">
                                        <input class="form-check-input" type="checkbox" id="emailPaymentCourses" checked>
                                        <label class="form-check-label d-none" for="emailPaymentCourses">Toggle Cours de paiement</label>
                                    </div>
                                </div>

                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <span class="text-white-50">Cours qui pourraient vous intéresser</span>
                                    <div class="form-check custom-checkbox">
                                        <input class="form-check-input" type="checkbox" id="emailSuggestedCourses">
                                        <label class="form-check-label d-none" for="emailSuggestedCourses">Toggle Cours qui pourraient vous intéresser</label>
                                    </div>
                                </div>

                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <span class="text-white-50">Notre promo intéressante</span>
                                    <div class="form-check custom-checkbox">
                                        <input class="form-check-input" type="checkbox" id="emailOurPromo">
                                        <label class="form-check-label d-none" for="emailOurPromo">Toggle Notre promo intéressante</label>
                                    </div>
                                </div>

                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <span class="text-white-50">Mises à jour des cours</span>
                                    <div class="form-check custom-checkbox">
                                        <input class="form-check-input" type="checkbox" id="emailCourseUpdates">
                                        <label class="form-check-label d-none" for="emailCourseUpdates">Toggle Mises à jour des cours</label>
                                    </div>
                                </div>

                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <span class="text-white-50">Avis de renouvellement d'abonnement</span>
                                    <div class="form-check custom-checkbox">
                                        <input class="form-check-input" type="checkbox" id="emailSubscriptionRenewal">
                                        <label class="form-check-label d-none" for="emailSubscriptionRenewal">Toggle Avis de renouvellement d'abonnement</label>
                                    </div>
                                </div>

                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <span class="text-white-50">Réalisations de Certification</span>
                                    <div class="form-check custom-checkbox">
                                        <input class="form-check-input" type="checkbox" id="emailCertificationAchievements" checked>
                                        <label class="form-check-label d-none" for="emailCertificationAchievements">Toggle Réalisations de Certification</label>
                                    </div>
                                </div>

                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <span class="text-white-50">Demandes de commentaires</span>
                                    <div class="form-check custom-checkbox">
                                        <input class="form-check-input" type="checkbox" id="emailFeedbackRequests" checked>
                                        <label class="form-check-label d-none" for="emailFeedbackRequests">Toggle Demandes de commentaires</label>
                                    </div>
                                </div>
                            </div>
                        </div>
