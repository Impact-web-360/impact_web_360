    ...
    <div class="d-flex" id="wrapper">
        <div class="bg-dark sidebar" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush">
                ...
                <a href="paiement.html" class="list-group-item list-group-item-action bg-dark text-white active">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid py-4 main-content">
                <div class="payment-success-card animation-slide-in-up">
                    <div class="card-header d-flex align-items-center">
                        <span class="text-white-50">Master Class: React JS et Tailwind CSS</span>
                        <i class="fas fa-chevron-right mx-2 text-white-50"></i>
                        <span class="text-white">Passer à la caisse</span>
                    </div>
                    <div class="card-body text-center">
                        <h3 class="text-white mb-4">Votre paiement a réussi!</h3>
                        <p class="text-white-50 fs-6 mb-5">Félicitations! Votre paiement a réussi! Merci d'avoir choisi nos cours. Votre reçu a été envoyé à votre email pour vos dossiers. Préparez-vous pour une expérience d'apprentissage enrichissante. Heureux d'étudier, et n'hésitez pas à contacter si vous avez besoin d'aide le long du chemin!</p>

                        <div class="row payment-details-section">
                            <div class="col-lg-6 col-md-12 order-lg-1 order-2 payment-info-col">
                                <div class="payment-summary text-start">
                                    <div class="d-flex justify-content-between mb-2">
                                        <span class="text-white-50">Date de naissance</span>
                                        <span class="text-white">Le 23 novembre 2023</span>
                                    </div>
                                    <div class="d-flex justify-content-between mb-2">
                                        <span class="text-white-50">Le temps</span>
                                        <span class="text-white">17h30 à 17h30</span>
                                    </div>
                                    <div class="d-flex justify-content-between mb-2">
                                        <span class="text-white-50">Paiement avec</span>
                                        <span class="text-white">Carte de crédit/débit</span>
                                    </div>
                                    <div class="d-flex justify-content-between mb-4">
                                        <span class="text-white-50">Numéro de carte</span>
                                        <span class="text-white">1234 5678 9012 1345</span>
                                    </div>

                                    <div class="course-item mb-3">
                                        <h5 class="course-title text-white">Master Class: React JS et Tailwind CSS</h5>
                                        <p class="course-meta text-white-50">16 Modules • 41 vidéos</p>
                                        <span class="course-price text-white">$595</span>
                                    </div>
                                    <div class="course-item mb-4">
                                        <h5 class="course-title text-white">Apprendre de base: React Javascript</h5>
                                        <p class="course-meta text-white-50">21 Modules • 50 vidéos</p>
                                        <span class="course-price text-white">$595</span>
                                    </div>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mb-2 position-relative">
                                        ...
                                        <span class="text-white">$119</span>
                                        <img src="" alt="Paid Stamp" class="paid-stamp position-absolute">
                                    </div>
                                    <div class="d-flex justify-content-between mb-2">
                                        <span class="text-white-50">Remise (60%)</span>
                                        <span class="text-primary">-$714</span>
                                    </div>
                                    <div class="d-flex justify-content-between mb-4">
                                        <span class="text-white-50">Frais de Service (3%)</span>
                                        <span class="text-white">$1.4</span>
                                    </div>
                                    <div class="d-flex justify-content-between final-total pt-3">
                                        <span class="text-white-50 fw-bold fs-5">Total Total</span>
                                        <span class="text-primary fw-bold fs-4">$49</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-12 order-lg-2 order-1 payment-illustration-col position-relative">
                                <img src="" alt="Payment Illustration" class="img-fluid payment-illustration mt-5">
                            </div>
                        </div>

                        <div class="d-flex justify-content-center mt-5 button-group">
                            <button class="btn btn-secondary-outline me-3 animation-fade-in" style="animation-delay: 0.8s;">Retour au tableau de bord</button>
                            <button class="btn btn-primary animation-fade-in" style="animation-delay: 1s;">Commencer à pencher</button>
                        </div>
                    </div>
                </div>
            </div>
