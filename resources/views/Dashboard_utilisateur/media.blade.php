...
<head>
    ...
    <style>
        ...
        .social-card { /* Common styling for card-like sections */
            background-color: var(--dark-card-bg);
        ...
        .social-input-group .form-control-custom {
            border-left: none; /* Remove left border for seamless look with icon */
                ...
                <div class="row">
                   <div class="col-md-4 col-lg-3 settings-menu-col animation-slide-in-up">
                        <ul class="list-unstyled settings-menu">
                            ...
                            <li><a href="{{ route('media') }}" class="active"><i class="fas fa-share-alt me-2"></i> Médias sociaux</a></li>
                    ...
                    <div class="col-md-8 col-lg-9 social-settings-form animation-fade-in" style="animation-delay: 0.2s;">
                        ...
                        <form>
                            <div class="card social-card mb-4">
                                <div class="card-body">
                                    ...
                                    <p class="card-subtitle mb-4 text-muted">Mettez à jour les liens vers vos profils de médias sociaux pour les afficher sur votre page de profil.</p>

                                    <div class="mb-3">
                                        <label for="facebookLink" class="form-label-custom">Facebook</label>
                                        <div class="input-group social-input-group">
                                            <span class="input-group-text"><i class="fab fa-facebook-f"></i></span>
                                            <input type="text" class="form-control form-control-custom" id="facebookLink" placeholder="https://facebook.com/votreprofil">
                                        </div>
                                    </div>

                                    <div class="mb-3">
                                        <label for="twitterLink" class="form-label-custom">Twitter (X)</label>
                                        <div class="input-group social-input-group">
                                            <span class="input-group-text"><i class="fab fa-x-twitter"></i></span>
                                            <input type="text" class="form-control form-control-custom" id="twitterLink" placeholder="https://twitter.com/votreprofil">
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group social-input-group">
                                            ...
                                            <input type="text" class="form-control form-control-custom" id="instagramLink" placeholder="https://instagram.com/votreprofil">
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group social-input-group">
                                            ...
                                            <input type="text" class="form-control form-control-custom" id="linkedinLink" placeholder="https://linkedin.com/in/votreprofil">
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group social-input-group">
                                            ...
                                            <input type="text" class="form-control form-control-custom" id="youtubeLink" placeholder="https://youtube.com/c/votrechaine">
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group social-input-group">
                                            ...
                                            <input type="text" class="form-control form-control-custom" id="tiktokLink" placeholder="https://tiktok.com/@votreprofil">
                                        </div>
                                    </div>
