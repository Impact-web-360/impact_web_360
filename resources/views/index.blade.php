...
<head>
  ...
  <style>
    ...
    /* ----- Partie forum ----- */
    .forum-section { padding: 60px 15px; }
    .forum-title { font-size: 2.5rem; font-weight: 700; }
    .forum-text { color: #ccc; font-size: 1rem; max-width: 600px; }
    .btn-join { background-color: red; color: #fff; padding: 12px 28px; border-radius: 30px; font-weight: 500; border: none; }
    .btn-join:hover { background-color: #ff2605; color: black; transform: scale(1.05); }
    .circle-container { position: relative; width: 400px; height: 400px; margin: 40px auto 0 auto; }

    /* Conteneur de rotation */
    .rotation-wrapper { position: absolute; width: 100%; height: 100%; animation: rotateCircle 30s linear infinite; transform-origin: center; }
    ...
    @keyframes pulseGlow {
      ...
      50% { filter: drop-shadow(0 0 30px #00bfff); }
      100% { filter: drop-shadow(0 0 0px #00bfff); }
    }

    /* Ombres sombres avatars */
    .user-img { position: absolute; width: 60px; height: 60px; border-radius: 50%; object-fit: cover; border: 0px solid #fff; filter: brightness(0.4); box-shadow: 0 6px 12px rgba(0, 0, 0, 0.7); }

    /* Halo bleu éclatant logo central */
    .center-logo { position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); width: 200px; animation: pulseGlow 2.5s ease-in-out infinite; }

    /* Positions circulaires statiques */
    .img1 { top: 0%; left: 50%; transform: translate(-50%, -50%); }
    .img2 { top: 20%; right: 0%; transform: translate(50%, -50%); }
    .img3 { bottom: 20%; right: 0%; transform: translate(50%, 50%); }
    .img4 { bottom: 0%; left: 50%; transform: translate(-50%, 50%); }
    .img5 { bottom: 20%; left: 0%; transform: translate(-50%, 50%); }
    .img6 { top: 20%; left: 0%; transform: translate(-50%, -50%); }
    ...
    @media (max-width: 976px) {
      ...
      .hero-section .overlay h1 { font-size: 2rem; line-height: 1.2; }
      .hero-section .overlay p { font-size: 2rem; }
      #countdown { font-size: 1rem;
       flex-wrap: wrap;
      }

      /* Événement section mobile */
      .titre-avec-trait { flex-direction: column; align-items: flex-start; }
      .trait-vertical { width: 50px; height: 4px; }
      ...
      .hero-section .overlay h1 { font-size: 1.8rem; }
      .hero-section .overlay p { font-size: 0.9rem; }
      ...
      /* Partenaires bande */
      .container.d-flex { flex-direction: column; gap: 10px; }

      /* Événement section */
      .row.mt-2.align-items-center .col-md-6 { margin-bottom: 20px; }
      .row.mt-2.align-items-center .col-md-6 img { max-width: 100%; height: auto; }
      .btn-join { margin-bottom: 30px; }
    }

    /* Très petits écrans */
    @media (max-width: 576px) {
      .center-logo { width: 300px; height: 100px; }
      .hero-section { height: 650px; }
      .hero-section .overlay h1 { font-size: 1.5rem; }
      .hero-section .overlay p { font-size: 0.8rem; }
      ...
      .btn-join { padding: 8px 20px; }
      .partners-section h2 { font-size: 1.8rem; }
      .logo-box { width: 60px; height: 60px; padding: 12px;}
      .btn-cta { padding: 10px 26px; font-size: 0.95rem; }
      .countdown-container { flex-wrap: wrap; justify-content: center; gap: 20px; padding: 20px; }
...
<section class="py-5 bg-black text-center taille" data-aos="fade-up" >
  <div class="container">
    ...
    <div class="row" data-aos="fade-up" data-aos-delay="100">
      <div class="col-md-4 mb-4" data-aos="flip-right"><h3 class="text-danger">+500</h3><p>participants en 2024</p></div>
      <div class="col-md-4 mb-4"><h3 class="text-danger">+15</h3><p>experts et intervenants</p></div>
      <div class="col-md-4 mb-4"><h3 class="text-danger">+1000</h3><p>connexions professionnelles</p></div>
    </div>
  </div>
</section>
 ...
 <section class="py-5 bg-black text-white">
    <div class="container" data-aos="zoom-in">
      <h2 class="mb-4 fw-bold text-center">Découvrez la boutique officielle <br>
        <span class="fw-bold" style="color: red; font-size: 40px;">    Impact Web 360</span></h2>
